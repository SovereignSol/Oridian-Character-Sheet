...
export function effectiveSpellcasterLevel(state){
  ...
  for (const b of blocks){
    ...
    else if (["Paladin","Ranger"].includes(name)) half += Math.floor(lv/2);
